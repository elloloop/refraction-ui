...
const components = [
  ...
  { name: 'Motion', href: '/components/motion', description: 'Page transitions, staggered reveals, handoff, celebrate and the other named motion patterns.', category: 'Core UI' },
