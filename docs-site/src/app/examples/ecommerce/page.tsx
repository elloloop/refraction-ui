      ...
      <section className="px-8 py-[var(--section-gap)]">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="flex items-center justify-between">
            ...
            <Link href="/examples/ecommerce/app" className="text-sm text-primary hover:underline">View all &rarr;</Link>
          </div>
      ...
      <footer className="border-t border-border bg-muted/20 px-8 py-10">
        <div className="max-w-4xl mx-auto grid md:grid-cols-4 gap-8">
          <div className="space-y-3">
            <h3 className="font-bold text-foreground">FORMA</h3>
            <p className="text-xs text-muted-foreground">Sustainable fashion for modern living.</p>
          </div>
