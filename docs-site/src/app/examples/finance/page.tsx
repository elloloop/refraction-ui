    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="sticky top-0 z-40 border-b border-border bg-background/80 backdrop-blur-sm">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <span className="text-xl font-bold text-primary">NeoBank</span>
          ...
          <div className="flex items-center gap-3">
            <Link href="/examples/finance/app" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
              Sign In
            </Link>
            <Link href="/examples/finance/app" className="rounded-[var(--button-radius)] bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:opacity-90 transition-opacity">
              Open Account
            </Link>
          </div>
        </div>
        ...
        <div className="grid gap-12 lg:grid-cols-2 items-center">
          <div>
            ...
            <div className="mt-10 flex gap-4">
              <Link href="/examples/finance/app" className="rounded-[var(--button-radius)] bg-primary px-6 py-3 text-sm font-medium text-primary-foreground shadow-lg hover:opacity-90 transition-opacity">
                Open Account
              </Link>
      ...
      <footer className="border-t border-border py-12">
        <div className="mx-auto max-w-6xl px-6 text-center">
          <span className="text-sm text-muted-foreground">&copy; 2026 NeoBank. All rights reserved. FDIC insured through partner banks.</span>
        </div>
      </footer>

      <ThemeDialog themeName="Finance" themeConfig={themeConfig} />
    </div>
  )
}
