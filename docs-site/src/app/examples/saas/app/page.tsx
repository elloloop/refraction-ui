...
const activities = [
  ...
  { date: 'Apr 3, 2026', user: 'Priya Patel', action: 'Set up Slack integration', status: 'completed' },
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <aside className="fixed inset-y-0 left-0 z-30 w-60 border-r border-border bg-card">
        ...
        <nav className="mt-4 space-y-1 px-3">
          {[
            { label: 'Dashboard', href: '/examples/saas/app', active: true, icon: <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" /></svg> },
      ...
      <ThemeDialog themeName="SaaS Dashboard" themeConfig={themeConfig} />
    </div>
  )
}
