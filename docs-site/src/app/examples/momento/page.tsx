    ...
    >
      ...
      <nav className="border-b border-border bg-background/80 backdrop-blur-sm sticky top-0 z-40">
        <div className="mx-auto max-w-6xl flex items-center justify-between px-6 py-4">
          <span className="text-2xl font-bold tracking-tight bg-gradient-to-r from-orange-400 via-amber-500 to-rose-500 bg-clip-text text-transparent">
            Momento
          </span>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              className="rounded-[var(--button-radius)] bg-gradient-to-r from-orange-400 via-amber-500 to-rose-500 px-4 py-2 text-sm font-medium text-white hover:opacity-90 transition-opacity"
            >
              Sign Up
            </Link>
          </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2 flex justify-center">
            <div className="relative w-72">
              <div className="rounded-[2rem] border-4 border-foreground/10 bg-card shadow-2xl overflow-hidden">
                <div className="h-[480px] bg-gradient-to-br from-orange-400 via-amber-500 to-rose-500 flex flex-col items-center justify-center p-6 text-white">
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-foreground leading-tight">
              Share your
              <span className="block bg-gradient-to-r from-orange-400 via-amber-500 to-rose-500 bg-clip-text text-transparent">
                world
              </span>
            </h1>
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {features.map((f) => (
              ...
              >
                <div className="mb-4 mx-auto inline-flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-orange-400/10 via-amber-500/10 to-rose-500/10 text-primary">
                  {f.icon}
                </div>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid gap-8 sm:grid-cols-3 text-center">
            <div>
              <p className="text-4xl font-bold bg-gradient-to-r from-orange-400 to-amber-500 bg-clip-text text-transparent">10M+</p>
              <p className="text-sm text-muted-foreground mt-2">Monthly active users</p>
            </div>
            <div>
              <p className="text-4xl font-bold bg-gradient-to-r from-amber-500 to-rose-500 bg-clip-text text-transparent">5M+</p>
              <p className="text-sm text-muted-foreground mt-2">Photos shared daily</p>
            </div>
            <div>
              <p className="text-4xl font-bold bg-gradient-to-r from-rose-500 to-orange-500 bg-clip-text text-transparent">20M+</p>
