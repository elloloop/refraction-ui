    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="sticky top-0 z-40 border-b border-border bg-background/80 backdrop-blur-sm">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <div className="hidden items-center gap-8 md:flex">
            ...
            <Link href="/examples/education/app" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Browse All</Link>
          </div>
          <div className="flex items-center gap-3">
            <Link href="/examples/education/app" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
              Sign In
            </Link>
            <Link href="/examples/education/app" className="rounded-[var(--button-radius)] bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:opacity-90 transition-opacity">
              Start Free
            </Link>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-24 text-center">
        ...
        <div className="mt-10 flex items-center justify-center gap-4">
          <Link href="/examples/education/app" className="rounded-[var(--button-radius)] bg-primary px-6 py-3 text-sm font-medium text-primary-foreground shadow-lg hover:opacity-90 transition-opacity">
            Browse Courses
          </Link>
          <Link href="/examples/education/app" className="rounded-[var(--button-radius)] border border-border px-6 py-3 text-sm font-medium text-foreground hover:bg-muted transition-colors">
            Start Free
          </Link>
        </div>
      ...
      <section id="courses" className="mx-auto max-w-6xl px-6 py-24">
        <div className="flex items-center justify-between mb-12">
          ...
          <Link href="/examples/education/app" className="text-sm font-medium text-primary hover:underline">
            View All Courses
          </Link>
        </div>
      ...
      <section className="bg-primary/5 py-24">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <Link href="/examples/education/app" className="mt-8 inline-block rounded-[var(--button-radius)] bg-primary px-8 py-3 text-sm font-medium text-primary-foreground shadow-lg hover:opacity-90 transition-opacity">
            Get Started Free
          </Link>
        </div>
      </section>
      ...
      <ThemeDialog themeName="Education" themeConfig={themeConfig} />
    </div>
  )
}
