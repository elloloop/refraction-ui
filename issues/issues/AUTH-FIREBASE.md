...
~~Create `@elloloop/auth-firebase` as a separate adapter package.~~

**SUPERSEDED** — Firebase adapter is now an **internal module** within `@elloloop/auth`, not a separate package. See AUTH-PROVIDER for details.
