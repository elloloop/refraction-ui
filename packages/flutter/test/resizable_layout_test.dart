...
void main() {
  ...
  testWidgets('applies default equal sizes if no defaultSizes provided', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(buildTestWidget());
  ...
  testWidgets('respects custom defaultSizes', (WidgetTester tester) async {
    await tester.pumpWidget(buildTestWidget(defaultSizes: [30.0, 70.0]));
    final pane0 = tester.getSize(find.byKey(const Key('pane_0')));
    final pane1 = tester.getSize(find.byKey(const Key('pane_1')));
  ...
  testWidgets('renders correct number of dividers', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('dragging divider resizes panes horizontally', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('dragging divider resizes panes vertically', (
    WidgetTester tester,
  ) async {
    List<double>? resizeResult;
