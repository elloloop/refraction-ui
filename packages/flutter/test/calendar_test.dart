...
class TestCalendarWrapper extends StatefulWidget {
  ...
  final Widget Function(BuildContext, DateTime, RefractionCalendarDayState)? dayBuilder;
...
void main() {
  group('RefractionCalendar Navigation', () {
    testWidgets('renders initial month correctly', (WidgetTester tester) async {
      await tester.pumpWidget(TestCalendarWrapper(
    ...
    for (int i = 1; i <= 12; i++) {
      testWidgets('renders month $i correctly', (WidgetTester tester) async {
        await tester.pumpWidget(TestCalendarWrapper(
          initialMonth: DateTime(2023, i, 15),
        ));
        final monthLabels = [
    ...
    testWidgets('respects selectedDate to set initial month', (WidgetTester tester) async {
      await tester.pumpWidget(TestCalendarWrapper(
        initialSelectedDate: DateTime(2022, 5, 20),
      ));
    ...
    testWidgets('handles leap year correctly', (WidgetTester tester) async {
      await tester.pumpWidget(TestCalendarWrapper(
        initialMonth: DateTime(2024, 2, 1),
      ));
  ...
  group('RefractionCalendar Single Selection', () {
    ...
    testWidgets('unselects date when tapped again', (WidgetTester tester) async {
      DateTime? selected;
      bool called = false;
      await tester.pumpWidget(TestCalendarWrapper(
        initialMonth: DateTime(2023, 10, 1),
    ...
    testWidgets('changes selected date when new date tapped', (WidgetTester tester) async {
      DateTime? selected;
      await tester.pumpWidget(TestCalendarWrapper(
        initialMonth: DateTime(2023, 10, 1),
        initialSelectedDate: DateTime(2023, 10, 15),
  ...
  group('RefractionCalendar Multiple Selection', () {
    ...
    testWidgets('deselects date when already selected', (WidgetTester tester) async {
      List<DateTime>? selected;
      await tester.pumpWidget(TestCalendarWrapper(
        initialMonth: DateTime(2023, 10, 1),
        selectionMode: RefractionCalendarSelectionMode.multiple,
        initialSelectedDates: [DateTime(2023, 10, 10), DateTime(2023, 10, 15)],
        onDatesSelected: (dates) => selected = dates,
      ));
    ...
    for (int i = 0; i < 5; i++) {
      testWidgets('deselect multiple date flow $i', (WidgetTester tester) async {
         List<DateTime>? selected;
         await tester.pumpWidget(TestCalendarWrapper(
           initialMonth: DateTime(2023, 10, 1),
           selectionMode: RefractionCalendarSelectionMode.multiple,
  ...
  group('RefractionCalendar Range Selection', () {
    ...
    testWidgets('selects backwards range correctly', (WidgetTester tester) async {
      DateTimeRange? range;
      await tester.pumpWidget(TestCalendarWrapper(
        initialMonth: DateTime(2023, 10, 1),
        selectionMode: RefractionCalendarSelectionMode.range,
    ...
    testWidgets('starts new range if range already selected', (WidgetTester tester) async {
      DateTimeRange? range;
      await tester.pumpWidget(TestCalendarWrapper(
        initialMonth: DateTime(2023, 10, 1),
        selectionMode: RefractionCalendarSelectionMode.range,
  ...
  group('RefractionCalendar None Selection', () {
    testWidgets('does not select when selectionMode is none', (WidgetTester tester) async {
      DateTime? selected;
      await tester.pumpWidget(TestCalendarWrapper(
        initialMonth: DateTime(2023, 10, 1),
  ...
  group('RefractionCalendar Bounds and Disabled', () {
    testWidgets('cannot select date before minDate', (WidgetTester tester) async {
      DateTime? selected;
      await tester.pumpWidget(TestCalendarWrapper(
        initialMonth: DateTime(2023, 10, 1),
    ...
    testWidgets('cannot select date after maxDate', (WidgetTester tester) async {
      DateTime? selected;
      await tester.pumpWidget(TestCalendarWrapper(
        initialMonth: DateTime(2023, 10, 1),
    ...
    for (int day = 1; day <= 9; day++) {
      testWidgets('cannot select $day if minDate is 10th', (WidgetTester tester) async {
         DateTime? selected;
         await tester.pumpWidget(TestCalendarWrapper(
           initialMonth: DateTime(2023, 10, 1),
           minDate: DateTime(2023, 10, 10),
  ...
  group('RefractionCalendar Outside Days', () {
    ...
    testWidgets('hides outside days when showOutsideDays is false', (WidgetTester tester) async {
      await tester.pumpWidget(TestCalendarWrapper(
        initialMonth: DateTime(2023, 10, 1),
  ...
  group('RefractionCalendar Custom Rendering', () {
    testWidgets('uses dayBuilder to render custom day', (WidgetTester tester) async {
      await tester.pumpWidget(TestCalendarWrapper(
        initialMonth: DateTime(2023, 10, 1),
    ...
    testWidgets('uses eventMarkersBuilder to render markers', (WidgetTester tester) async {
      await tester.pumpWidget(TestCalendarWrapper(
        initialMonth: DateTime(2023, 10, 1),
    ...
    for (int day = 10; day <= 14; day++) {
       testWidgets('custom builder day $day', (WidgetTester tester) async {
          await tester.pumpWidget(TestCalendarWrapper(
            initialMonth: DateTime(2023, 10, 1),
            dayBuilder: (c, d, s) {
              if (d.day == day && d.month == 10) return const Text("CUSTOM_DAY");
  ...
  group('RefractionCalendar Additional Tests', () {
    testWidgets('selects date on edge of month', (WidgetTester tester) async {
       ...
       await tester.ensureVisible(find.text("31").first); await tester.tap(find.text("31").first);
       await tester.pumpAndSettle();
       expect(selected!.day, 31);
    });

    testWidgets('multiple selection can toggle multiple times', (WidgetTester tester) async {
      List<DateTime>? selected;
      await tester.pumpWidget(TestCalendarWrapper(
        initialMonth: DateTime(2023, 1, 1),
        selectionMode: RefractionCalendarSelectionMode.multiple,
    ...
    testWidgets('range selection clears on third tap', (WidgetTester tester) async {
      DateTimeRange? range;
      await tester.pumpWidget(TestCalendarWrapper(
        initialMonth: DateTime(2023, 1, 1),
        selectionMode: RefractionCalendarSelectionMode.range,
