...
void main() {
  testGoldens('Pagination Goldens', (WidgetTester tester) async {
    final builderLight = GoldenBuilder.column()
      ..addScenario(
        'Default',
        Builder(builder: (ctx) => defaultPagination(ctx)),
      )
      ..addScenario(
        'Middle Page',
        Builder(builder: (ctx) => middlePagination(ctx)),
      )
      ..addScenario(
        'No Controls',
        Builder(builder: (ctx) => noControlsPagination(ctx)),
      );
