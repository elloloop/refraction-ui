...
void main() {
  ...
  group('RefractionCollapsible Rendering', () {
    ...
    testWidgets('SizeTransition initially 1 when defaultOpen=true', (tester) async {
      await tester.pumpWidget(
        buildTestApp(
          const RefractionCollapsible(
            defaultOpen: true,
  ...
  group('RefractionCollapsible Uncontrolled Toggle', () {
    for (int i = 0; i < 10; i++) {
      testWidgets('Uncontrolled toggle interaction iteration $i', (tester) async {
        await tester.pumpWidget(
          buildTestApp(
            const RefractionCollapsible(
              child: Column(
        ...
        expect(tester.widget<SizeTransition>(find.byType(SizeTransition)).sizeFactor.value, greaterThan(0.0));
        ...
        await tester.pump(const Duration(milliseconds: 50));
        expect(tester.widget<SizeTransition>(find.byType(SizeTransition)).sizeFactor.value, lessThan(1.0));
  ...
  group('RefractionCollapsible Controlled', () {
    for (int i = 0; i < 10; i++) {
      testWidgets('Controlled update toggles animation iteration $i', (tester) async {
    ...
    testWidgets('Tapping controlled trigger calls callback but does not animate immediately', (tester) async {
      bool? callbackValue;
      await tester.pumpWidget(
        buildTestApp(
          RefractionCollapsible(
  ...
  group('RefractionCollapsible Disabled', () {
    for (int i = 0; i < 10; i++) {
      testWidgets('Disabled state prevents toggle iteration $i', (tester) async {
  ...
  group('RefractionCollapsible Callbacks', () {
    for (int i = 0; i < 5; i++) {
      testWidgets('Callback passes correct value when opened iteration $i', (tester) async {
        bool? val;
        await tester.pumpWidget(
          buildTestApp(
            RefractionCollapsible(
      ...
      testWidgets('Callback passes correct value when closed iteration $i', (tester) async {
        bool? val;
        await tester.pumpWidget(
          buildTestApp(
            RefractionCollapsible(
  ...
  group('Nested and Error States', () {
    ...
    testWidgets('Nested collapsibles operate independently', (tester) async {
              ...
              children: [
                ...
                RefractionCollapsibleContent(
                  child: RefractionCollapsible(
                    ...
                    child: Column(
                      children: [
                        RefractionCollapsibleTrigger(child: Text('InnerTrigger')),
                        RefractionCollapsibleContent(child: Text('InnerContent')),
                      ],
                    ),
                  ),
                ),
      ...
      final outerSt = tester.widget<SizeTransition>(find.byType(SizeTransition).first);
      final innerSt = tester.widget<SizeTransition>(find.byType(SizeTransition).last);
      ...
      expect(tester.widget<SizeTransition>(find.byType(SizeTransition).first).sizeFactor.value, 1.0);
      expect(tester.widget<SizeTransition>(find.byType(SizeTransition).last).sizeFactor.value, 0.0);

      await tester.tap(find.text('InnerTrigger'));
      await tester.pumpAndSettle();
      
      expect(tester.widget<SizeTransition>(find.byType(SizeTransition).first).sizeFactor.value, 1.0);
      expect(tester.widget<SizeTransition>(find.byType(SizeTransition).last).sizeFactor.value, 1.0);
    });
  });
}
