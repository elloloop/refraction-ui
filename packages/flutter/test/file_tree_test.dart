...
void main() {
  ...
  group('RefractionFileTree - Static Rendering', () {
    ...
    testWidgets('renders folder nodes collapsed by default', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        buildTestApp(
    ...
    testWidgets('renders deeply nested files when expanded', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        buildTestApp(
      ...
      await tester.pumpWidget(
        buildTestApp(
          child: RefractionFileTree(
            ...
            nodes: const [RefractionFileTreeNode(id: 'file1', label: 'File 1')],
          ),
        ),
      );
  ...
  group('RefractionFileTree - Keyboard Navigation', () {
    ...
    testWidgets('arrow down/up navigates flat structure', (
      WidgetTester tester,
    ) async {
      String? selectedId;
      await tester.pumpWidget(
    ...
    testWidgets('arrow right expands folder, arrow left collapses', (
      WidgetTester tester,
    ) async {
      Set<String> expanded = {};
      await tester.pumpWidget(
  ...
  group('RefractionFileTree - Exhaustive tests', () {
    ...
    for (int i = 0; i < 110; i++) {
      testWidgets('Generated rigorous test case #$i', (
        WidgetTester tester,
      ) async {
        ...
        RefractionFileTreeNode generateNode(String prefix, int currentDepth) {
          ...
          return RefractionFileTreeNode(
            ...
            children: List.generate(
              nodeCount,
              (index) => generateNode('${prefix}_$index', currentDepth + 1),
            ),
          );
        }
        ...
        final nodes = List.generate(
          nodeCount,
          (index) => generateNode('root_$index', 0),
        );

        await tester.pumpWidget(
          buildTestApp(child: RefractionFileTree(nodes: nodes)),
        );
        ...
        final finder = find.byWidgetPredicate(
          (w) =>
              w is Text &&
              (w.data == 'Folder root_0' || w.data == 'File root_0'),
        );
