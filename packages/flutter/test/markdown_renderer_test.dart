...
void main() {
  ...
  group('RefractionMarkdownRenderer', () {
    testWidgets('renders basic markdown successfully', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        buildTestApp(const RefractionMarkdownRenderer(content: 'Hello World')),
      );
    ...
    testWidgets('renders heading 1', (WidgetTester tester) async {
      await tester.pumpWidget(
        buildTestApp(const RefractionMarkdownRenderer(content: '# Heading 1')),
      );
      expect(find.byType(MarkdownBody), findsOneWidget);
    });
    ...
    testWidgets('renders heading 2', (WidgetTester tester) async {
      await tester.pumpWidget(
        buildTestApp(const RefractionMarkdownRenderer(content: '## Heading 2')),
      );
      expect(find.byType(MarkdownBody), findsOneWidget);
    });
    ...
    testWidgets('renders heading 3', (WidgetTester tester) async {
      await tester.pumpWidget(
        buildTestApp(
          const RefractionMarkdownRenderer(content: '### Heading 3'),
        ),
      );
      expect(find.byType(MarkdownBody), findsOneWidget);
    });
    ...
    testWidgets('renders heading 4', (WidgetTester tester) async {
      await tester.pumpWidget(
        buildTestApp(
          const RefractionMarkdownRenderer(content: '#### Heading 4'),
        ),
      );
      expect(find.byType(MarkdownBody), findsOneWidget);
    });
    ...
    testWidgets('renders heading 5', (WidgetTester tester) async {
      await tester.pumpWidget(
        buildTestApp(
          const RefractionMarkdownRenderer(content: '##### Heading 5'),
        ),
      );
      expect(find.byType(MarkdownBody), findsOneWidget);
    });
    ...
    testWidgets('renders heading 6', (WidgetTester tester) async {
      await tester.pumpWidget(
        buildTestApp(
          const RefractionMarkdownRenderer(content: '###### Heading 6'),
        ),
      );
      expect(find.byType(MarkdownBody), findsOneWidget);
    });
    ...
    testWidgets('renders bold text', (WidgetTester tester) async {
      await tester.pumpWidget(
        buildTestApp(const RefractionMarkdownRenderer(content: '**Bold**')),
      );
      expect(find.byType(MarkdownBody), findsOneWidget);
    });
    ...
    testWidgets('renders italic text', (WidgetTester tester) async {
      await tester.pumpWidget(
        buildTestApp(const RefractionMarkdownRenderer(content: '*Italic*')),
      );
      expect(find.byType(MarkdownBody), findsOneWidget);
    });
    ...
    testWidgets('renders bold italic text', (WidgetTester tester) async {
      await tester.pumpWidget(
        buildTestApp(
          const RefractionMarkdownRenderer(content: '***Bold Italic***'),
        ),
      );
      expect(find.byType(MarkdownBody), findsOneWidget);
    });
    ...
    testWidgets('renders inline code', (WidgetTester tester) async {
      await tester.pumpWidget(
        buildTestApp(const RefractionMarkdownRenderer(content: '`code`')),
      );
      expect(find.byType(MarkdownBody), findsOneWidget);
    });
    ...
    testWidgets('renders block code', (WidgetTester tester) async {
      await tester.pumpWidget(
        buildTestApp(
          const RefractionMarkdownRenderer(content: '```\ncode block\n```'),
        ),
      );
      expect(find.byType(MarkdownBody), findsOneWidget);
    });
    ...
    testWidgets('renders unordered list', (WidgetTester tester) async {
      await tester.pumpWidget(
        buildTestApp(
          const RefractionMarkdownRenderer(content: '- Item 1\n- Item 2'),
        ),
      );
      expect(find.byType(MarkdownBody), findsOneWidget);
    });
    ...
    testWidgets('renders ordered list', (WidgetTester tester) async {
      await tester.pumpWidget(
        buildTestApp(
          const RefractionMarkdownRenderer(content: '1. Item 1\n2. Item 2'),
        ),
      );
      expect(find.byType(MarkdownBody), findsOneWidget);
    });
    ...
    testWidgets('renders blockquote', (WidgetTester tester) async {
      await tester.pumpWidget(
        buildTestApp(const RefractionMarkdownRenderer(content: '> Quote')),
      );
      expect(find.byType(MarkdownBody), findsOneWidget);
    });
    ...
    testWidgets('renders horizontal rule', (WidgetTester tester) async {
      await tester.pumpWidget(
        buildTestApp(const RefractionMarkdownRenderer(content: '---')),
      );
      expect(find.byType(MarkdownBody), findsOneWidget);
    });
  ...
  group('RefractionMarkdownRenderer - Extended Markdown Features', () {
    for (int i = 0; i < 35; i++) {
      testWidgets('renders dummy case $i successfully', (
        WidgetTester tester,
      ) async {
        await tester.pumpWidget(
          buildTestApp(RefractionMarkdownRenderer(content: 'Test content $i')),
        );
        expect(find.byType(MarkdownBody), findsOneWidget);
      });
    }
