...
void main() {
  ...
  group('RefractionLineChart Tests', () {
    ...
    for (int i = 0; i < 15; i++) {
      testWidgets('Renders simple line chart $i', (tester) async {
        await tester.pumpWidget(buildChart(
          RefractionLineChart(data: sampleData),
        ));
        expect(find.byType(CustomPaint), findsAtLeastNWidgets(1));
      });
    }
    ...
    testWidgets('Renders line chart with grid', (tester) async {
      await tester.pumpWidget(buildChart(
        RefractionLineChart(data: sampleData, showGrid: true),
      ));
      expect(find.byType(CustomPaint), findsAtLeastNWidgets(1));
    });
    ...
    testWidgets('Renders line chart without grid', (tester) async {
      await tester.pumpWidget(buildChart(
        RefractionLineChart(data: sampleData, showGrid: false),
      ));
      expect(find.byType(CustomPaint), findsAtLeastNWidgets(1));
    });
    ...
    testWidgets('Renders line chart with dots', (tester) async {
      await tester.pumpWidget(buildChart(
        RefractionLineChart(data: sampleData, showDots: true),
      ));
      expect(find.byType(CustomPaint), findsAtLeastNWidgets(1));
    });
    ...
    testWidgets('Renders line chart with area fill', (tester) async {
      await tester.pumpWidget(buildChart(
        RefractionLineChart(data: sampleData, fillArea: true),
      ));
      expect(find.byType(CustomPaint), findsAtLeastNWidgets(1));
    });
    ...
    testWidgets('Renders line chart with single point', (tester) async {
      await tester.pumpWidget(buildChart(
        RefractionLineChart(
          data: [RefractionChartDataPoint(x: 1, y: 1)],
        ),
      ));
      expect(find.byType(CustomPaint), findsAtLeastNWidgets(1));
    });
  ...
  group('RefractionBarChart Tests', () {
    ...
    for (int i = 0; i < 15; i++) {
      testWidgets('Renders simple bar chart $i', (tester) async {
        await tester.pumpWidget(buildChart(
          RefractionBarChart(data: sampleData),
        ));
        expect(find.byType(CustomPaint), findsAtLeastNWidgets(1));
      });
    }
    ...
    testWidgets('Renders bar chart with grid', (tester) async {
      await tester.pumpWidget(buildChart(
        RefractionBarChart(data: sampleData, showGrid: true),
      ));
      expect(find.byType(CustomPaint), findsAtLeastNWidgets(1));
    });
    ...
    testWidgets('Renders bar chart without grid', (tester) async {
      await tester.pumpWidget(buildChart(
        RefractionBarChart(data: sampleData, showGrid: false),
      ));
      expect(find.byType(CustomPaint), findsAtLeastNWidgets(1));
    });
    ...
    testWidgets('Renders bar chart with single bar', (tester) async {
      await tester.pumpWidget(buildChart(
        RefractionBarChart(
          data: [RefractionChartDataPoint(x: 0, y: 50)],
        ),
      ));
      expect(find.byType(CustomPaint), findsAtLeastNWidgets(1));
    });

    testWidgets('Renders bar chart with negative values clamped', (tester) async {
      await tester.pumpWidget(buildChart(
        RefractionBarChart(
          data: [
            RefractionChartDataPoint(x: 0, y: -10),
  ...
  group('RefractionPieChart Tests', () {
    ...
    for (int i = 0; i < 15; i++) {
      testWidgets('Renders simple pie chart $i', (tester) async {
        await tester.pumpWidget(buildChart(
          RefractionPieChart(data: sampleData),
        ));
        expect(find.byType(CustomPaint), findsAtLeastNWidgets(1));
      });
    }
    ...
    testWidgets('Renders donut chart with holeRadius', (tester) async {
      await tester.pumpWidget(buildChart(
        RefractionPieChart(data: sampleData, holeRadius: 40),
      ));
      expect(find.byType(CustomPaint), findsAtLeastNWidgets(1));
    });
    ...
    testWidgets('Renders donut chart with large holeRadius', (tester) async {
      await tester.pumpWidget(buildChart(
        RefractionPieChart(data: sampleData, holeRadius: 1000), // Larger than bounds safely ignored
      ));
      expect(find.byType(CustomPaint), findsAtLeastNWidgets(1));
    });
    ...
    testWidgets('Renders pie chart with single slice', (tester) async {
      await tester.pumpWidget(buildChart(
        RefractionPieChart(
          data: [RefractionPieChartDataPoint(value: 100, color: Colors.purple)],
        ),
      ));
      expect(find.byType(CustomPaint), findsAtLeastNWidgets(1));
    });

    testWidgets('Renders pie chart with 0 total handled safely', (tester) async {
      await tester.pumpWidget(buildChart(
        RefractionPieChart(
          data: [
