...
export const stories = [
  { name: 'Your Story', avatar: <img src="/assets/people/ea/ea-4-portrait.jpg" className="w-full h-full object-cover rounded-full" alt="You" />, isOwn: true, seen: false },
  { name: 'sophia_art', avatar: <img src="/assets/people/eu/eu-3-portrait.jpg" className="w-full h-full object-cover rounded-full" alt="SA" />, isOwn: false, seen: false },
  { name: 'mike.travels', avatar: <img src="/assets/people/af/af-1-portrait.jpg" className="w-full h-full object-cover rounded-full" alt="MT" />, isOwn: false, seen: false },
  { name: 'cooking_with_j', avatar: <img src="/assets/people/am/am-2-portrait.jpg" className="w-full h-full object-cover rounded-full" alt="CJ" />, isOwn: false, seen: false },
  { name: 'fit.emma', avatar: <img src="/assets/people/ea/ea-2-portrait.jpg" className="w-full h-full object-cover rounded-full" alt="FE" />, isOwn: false, seen: true },
  { name: 'alex.dev', avatar: <img src="/assets/people/sa/sa-1-portrait.jpg" className="w-full h-full object-cover rounded-full" alt="AD" />, isOwn: false, seen: false },
  { name: 'natalie.photo', avatar: <img src="/assets/people/me/me-1-portrait.jpg" className="w-full h-full object-cover rounded-full" alt="NP" />, isOwn: false, seen: true },
  { name: 'james_music', avatar: <img src="/assets/people/eu/eu-1-portrait.jpg" className="w-full h-full object-cover rounded-full" alt="JM" />, isOwn: false, seen: true },
]
