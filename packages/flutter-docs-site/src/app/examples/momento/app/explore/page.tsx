...
export default function ExplorePage() {
  ...
  return (
    <AppShell config={{ mobileNavPosition: 'bottom' }}>
      <AppShell.Main>
        <AppShell.Header className="bg-background/80 backdrop-blur-sm flex-col !h-auto py-3">
          <div className="mx-auto max-w-xl w-full px-4 space-y-3">
            {/* Search bar */}
        ...
        <AppShell.Content className="pb-16">
          {/* Masonry grid */}
